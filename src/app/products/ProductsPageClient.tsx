...
function ProductsPageContent({ initialProducts, initialCategories, initialBrands }: ProductsPageClientProps) {
  const searchParams = useSearchParams();
  const [products, setProducts] = useState<Product[]>(initialProducts);
  const [categories, setCategories] = useState<ProductsCategory[]>(initialCategories);
  const [brands, setBrands] = useState<ProductsBrand[]>(initialBrands);
