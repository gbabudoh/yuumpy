...
import { CreditCard, Save, Eye } from 'lucide-react';
...
export default function AdvertPageManagement() {
  ...
  const fetchPageContent = async () => {
    try {
      const response = await fetch('/api/pages?slug=advert');
      if (response.ok) {
...
const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        alert('Advert page updated successfully!');
        fetchPageContent();
      } else {
        const data = await response.json();
      ...
      <AdminLayout>
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading Advert page content...</p>
          </div>
        </div>
      </AdminLayout>
    );
    ...
    <AdminLayout>
      <div>
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Advert Page Management</h1>
            <p className="text-gray-600 mt-2">Update the content for the Advertising page</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Advertise With Us - Yuumpy"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Promote your products with Yuumpy's premium banner advertising options."
                />
              </div>
