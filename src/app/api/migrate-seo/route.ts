...
export async function POST(request: NextRequest) {
  try {
    ...
    // Create category SEO table
    const createCategorySeoTable = `
    ...
    await query(createSeoSettingsTable);
    console.log('✅ Created seo_settings table');

    await query(createProductSeoTable);
    console.log('✅ Created product_seo table');

    await query(createCategorySeoTable);
    console.log('✅ Created category_seo table');

    await query(createPageSeoTable);
    ...
    return NextResponse.json(
      { 
        success: false, 
        error: 'Failed to migrate SEO database',
